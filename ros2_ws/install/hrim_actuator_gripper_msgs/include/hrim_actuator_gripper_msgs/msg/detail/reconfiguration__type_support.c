...
#include <stddef.h>
#include "hrim_actuator_gripper_msgs/msg/detail/reconfiguration__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  hrim_actuator_gripper_msgs__msg__Reconfiguration__init(message_memory);
}

void Reconfiguration__rosidl_typesupport_introspection_c__Reconfiguration_fini_function(void * message_memory)
{
  hrim_actuator_gripper_msgs__msg__Reconfiguration__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Reconfiguration__rosidl_typesupport_introspection_c__Reconfiguration_message_member_array[7] = {
  {
    ...
    offsetof(hrim_actuator_gripper_msgs__msg__Reconfiguration, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs__msg__Reconfiguration, orientation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs__msg__Reconfiguration, orientation_covariance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs__msg__Reconfiguration, angular_velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs__msg__Reconfiguration, angular_velocity_covariance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs__msg__Reconfiguration, linear_acceleration),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs__msg__Reconfiguration, linear_acceleration_covariance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Reconfiguration__rosidl_typesupport_introspection_c__Reconfiguration_message_members = {
  ...
  7,  // number of fields
  sizeof(hrim_actuator_gripper_msgs__msg__Reconfiguration),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hrim_actuator_gripper_msgs, msg, Reconfiguration)() {
