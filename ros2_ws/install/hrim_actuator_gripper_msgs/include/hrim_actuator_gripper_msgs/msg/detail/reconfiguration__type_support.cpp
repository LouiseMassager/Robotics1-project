...
{
  new (message_memory) hrim_actuator_gripper_msgs::msg::Reconfiguration(_init);
}

void Reconfiguration_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hrim_actuator_gripper_msgs::msg::Reconfiguration *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Reconfiguration_message_member_array[7] = {
  {
    ...
    offsetof(hrim_actuator_gripper_msgs::msg::Reconfiguration, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs::msg::Reconfiguration, orientation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs::msg::Reconfiguration, orientation_covariance),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs::msg::Reconfiguration, angular_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs::msg::Reconfiguration, angular_velocity_covariance),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs::msg::Reconfiguration, linear_acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_gripper_msgs::msg::Reconfiguration, linear_acceleration_covariance),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Reconfiguration_message_members = {
  ...
  7,  // number of fields
  sizeof(hrim_actuator_gripper_msgs::msg::Reconfiguration),
...
get_message_type_support_handle<hrim_actuator_gripper_msgs::msg::Reconfiguration>()
{
  return &::hrim_actuator_gripper_msgs::msg::rosidl_typesupport_introspection_cpp::Reconfiguration_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hrim_actuator_gripper_msgs, msg, Reconfiguration)() {
  return &::hrim_actuator_gripper_msgs::msg::rosidl_typesupport_introspection_cpp::Reconfiguration_message_type_support_handle;
}
