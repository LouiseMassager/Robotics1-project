...
#ifndef HRIM_GENERIC_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
#define HRIM_GENERIC_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
 ...
 * calls
 * hrim_generic_msgs__msg__Status__init().
...
/**
 * It calls
 * hrim_generic_msgs__msg__Status__fini()
 ...
 * hrim_generic_msgs__msg__Status__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hrim_generic_msgs__msg__Status__Sequence__fini()
 * on the array,
...
#endif  // HRIM_GENERIC_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
