...
bool hrim_actuator_rotaryservo_msgs__msg__temperature__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hrim_actuator_rotaryservo_msgs.msg._temperature.Temperature", full_classname_dest, 59) == 0);
  }
  hrim_actuator_rotaryservo_msgs__msg__Temperature * ros_message = _ros_message;
  {  // header
  ...
  {  // temperature_error
    ...
    ros_message->temperature_error = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * hrim_actuator_rotaryservo_msgs__msg__temperature__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hrim_actuator_rotaryservo_msgs.msg._temperature");
  ...
  {  // temperature_error
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->temperature_error ? 1 : 0);
    {
