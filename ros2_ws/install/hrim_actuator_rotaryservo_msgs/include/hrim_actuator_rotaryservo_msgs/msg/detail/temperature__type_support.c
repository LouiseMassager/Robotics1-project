...
#include <stddef.h>
#include "hrim_actuator_rotaryservo_msgs/msg/detail/temperature__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  hrim_actuator_rotaryservo_msgs__msg__Temperature__init(message_memory);
}

void Temperature__rosidl_typesupport_introspection_c__Temperature_fini_function(void * message_memory)
{
  hrim_actuator_rotaryservo_msgs__msg__Temperature__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Temperature__rosidl_typesupport_introspection_c__Temperature_message_member_array[3] = {
  {
    ...
    offsetof(hrim_actuator_rotaryservo_msgs__msg__Temperature, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_rotaryservo_msgs__msg__Temperature, temperature),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hrim_actuator_rotaryservo_msgs__msg__Temperature, temperature_error),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Temperature__rosidl_typesupport_introspection_c__Temperature_message_members = {
  ...
  3,  // number of fields
  sizeof(hrim_actuator_rotaryservo_msgs__msg__Temperature),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hrim_actuator_rotaryservo_msgs, msg, Temperature)() {
