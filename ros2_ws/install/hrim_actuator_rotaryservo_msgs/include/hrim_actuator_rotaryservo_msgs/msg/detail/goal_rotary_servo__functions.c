...
hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__init(hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__fini(msg);
    return false;
  }
  // control_type
  // position
...
{
  hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo * msg = (hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo *)malloc(sizeof(hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo));
  bool success = hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence__init(hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence * array, size_t size)
{
  ...
  hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo * data = NULL;
  if (size) {
    data = (hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo *)calloc(size, sizeof(hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence__fini(hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence * array = (hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence *)malloc(sizeof(hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    hrim_actuator_rotaryservo_msgs__msg__GoalRotaryServo__Sequence__fini(array);
  }
  free(array);
}
