...
#ifndef HRIM_ACTUATOR_ROTARYSERVO_SRVS__SRV__DETAIL__OPEN_CLOSE_BRAKE__FUNCTIONS_H_
#define HRIM_ACTUATOR_ROTARYSERVO_SRVS__SRV__DETAIL__OPEN_CLOSE_BRAKE__FUNCTIONS_H_
...
/// Initialize srv/OpenCloseBrake message.
/**
...
/// Finalize srv/OpenCloseBrake message.
/**
...
/// Create srv/OpenCloseBrake message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Request__init().
...
/// Destroy srv/OpenCloseBrake message.
/**
 * It calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Request__fini()
...
/// Initialize array of srv/OpenCloseBrake messages.
/**
...
/// Finalize array of srv/OpenCloseBrake messages.
/**
 * It calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Request__fini()
...
/// Create array of srv/OpenCloseBrake messages.
/**
 * It allocates the memory for the array and calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/OpenCloseBrake messages.
/**
 * It calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hrim_actuator_rotaryservo_srvs
...
/**
 * It calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hrim_actuator_rotaryservo_srvs
...
/**
 * It allocates the memory for the array and calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hrim_actuator_rotaryservo_srvs
...
/**
 * It calls
 * hrim_actuator_rotaryservo_srvs__srv__OpenCloseBrake_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HRIM_ACTUATOR_ROTARYSERVO_SRVS__SRV__DETAIL__OPEN_CLOSE_BRAKE__FUNCTIONS_H_
