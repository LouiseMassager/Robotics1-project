...
static const _Stop_Request_type_support_symbol_names_t _Stop_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_actuator_rotaryservo_srvs, srv, Stop_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hrim_actuator_rotaryservo_srvs, srv, Stop_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hrim_actuator_rotaryservo_srvs, srv, Stop_Request)() {
  return &::hrim_actuator_rotaryservo_srvs::srv::rosidl_typesupport_c::Stop_Request_message_type_support_handle;
}
...
static const _Stop_Response_type_support_symbol_names_t _Stop_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_actuator_rotaryservo_srvs, srv, Stop_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hrim_actuator_rotaryservo_srvs, srv, Stop_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_hrim_actuator_rotaryservo_srvs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hrim_actuator_rotaryservo_srvs, srv, Stop_Response)() {
  return &::hrim_actuator_rotaryservo_srvs::srv::rosidl_typesupport_c::Stop_Response_message_type_support_handle;
}
...
static const _Stop_type_support_symbol_names_t _Stop_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_actuator_rotaryservo_srvs, srv, Stop)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hrim_actuator_rotaryservo_srvs, srv, Stop)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hrim_actuator_rotaryservo_srvs, srv, Stop)() {
  return &::hrim_actuator_rotaryservo_srvs::srv::rosidl_typesupport_c::Stop_service_type_support_handle;
}
