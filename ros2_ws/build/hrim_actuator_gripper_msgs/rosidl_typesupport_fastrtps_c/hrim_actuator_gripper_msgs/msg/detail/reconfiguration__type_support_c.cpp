...
#include "hrim_actuator_gripper_msgs/msg/detail/reconfiguration__rosidl_typesupport_fastrtps_c.h"
...
using _Reconfiguration__ros_msg_type = hrim_actuator_gripper_msgs__msg__Reconfiguration;
...
size_t get_serialized_size_hrim_actuator_gripper_msgs__msg__Reconfiguration(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Reconfiguration__ros_msg_type * ros_message = static_cast<const _Reconfiguration__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Reconfiguration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hrim_actuator_gripper_msgs__msg__Reconfiguration(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hrim_actuator_gripper_msgs
size_t max_serialized_size_hrim_actuator_gripper_msgs__msg__Reconfiguration(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_hrim_actuator_gripper_msgs__msg__Reconfiguration(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_actuator_gripper_msgs, msg, Reconfiguration)() {
