...
bool hrim_actuator_gripper_msgs__msg__state_gripper__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hrim_actuator_gripper_msgs.msg._state_gripper.StateGripper", full_classname_dest, 58) == 0);
  }
  hrim_actuator_gripper_msgs__msg__StateGripper * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of StateGripper */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hrim_actuator_gripper_msgs.msg._state_gripper");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StateGripper");
