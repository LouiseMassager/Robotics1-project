...
bool hrim_actuator_gripper_msgs__msg__reconfiguration__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hrim_actuator_gripper_msgs.msg._reconfiguration.Reconfiguration", full_classname_dest, 63) == 0);
  }
  hrim_actuator_gripper_msgs__msg__Reconfiguration * ros_message = _ros_message;
  {  // header
...
PyObject * hrim_actuator_gripper_msgs__msg__reconfiguration__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hrim_actuator_gripper_msgs.msg._reconfiguration");
