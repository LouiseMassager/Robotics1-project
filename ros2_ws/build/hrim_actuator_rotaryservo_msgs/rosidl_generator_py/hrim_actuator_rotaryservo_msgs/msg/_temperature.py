    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hrim_actuator_rotaryservo_msgs.msg.Temperature')
            logger.debug(
...
class Temperature(metaclass=Metaclass_Temperature):
    ...
    def __init__(self, **kwargs):
        ...
        self.temperature_error = kwargs.get('temperature_error', bool())
    ...
    def temperature_error(self, value):
        if __debug__:
            assert \
                ...
                "The 'temperature_error' field must be of type 'bool'"
