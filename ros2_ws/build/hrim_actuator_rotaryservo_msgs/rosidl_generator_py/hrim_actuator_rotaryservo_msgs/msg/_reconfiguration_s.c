...
bool hrim_actuator_rotaryservo_msgs__msg__reconfiguration__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hrim_actuator_rotaryservo_msgs.msg._reconfiguration.Reconfiguration", full_classname_dest, 67) == 0);
  }
  hrim_actuator_rotaryservo_msgs__msg__Reconfiguration * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Reconfiguration */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hrim_actuator_rotaryservo_msgs.msg._reconfiguration");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Reconfiguration");
