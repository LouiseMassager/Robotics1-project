...
#include "hrim_actuator_rotaryservo_msgs/msg/detail/state_rotary_servo__rosidl_typesupport_fastrtps_c.h"
...
using _StateRotaryServo__ros_msg_type = hrim_actuator_rotaryservo_msgs__msg__StateRotaryServo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _StateRotaryServo__ros_msg_type * ros_message = static_cast<const _StateRotaryServo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _StateRotaryServo__ros_msg_type * ros_message = static_cast<_StateRotaryServo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_hrim_actuator_rotaryservo_msgs__msg__StateRotaryServo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StateRotaryServo__ros_msg_type * ros_message = static_cast<const _StateRotaryServo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _StateRotaryServo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hrim_actuator_rotaryservo_msgs__msg__StateRotaryServo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hrim_actuator_rotaryservo_msgs
size_t max_serialized_size_hrim_actuator_rotaryservo_msgs__msg__StateRotaryServo(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_hrim_actuator_rotaryservo_msgs__msg__StateRotaryServo(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_StateRotaryServo = {
...
static rosidl_message_type_support_t _StateRotaryServo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_StateRotaryServo,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_actuator_rotaryservo_msgs, msg, StateRotaryServo)() {
  return &_StateRotaryServo__type_support;
}
