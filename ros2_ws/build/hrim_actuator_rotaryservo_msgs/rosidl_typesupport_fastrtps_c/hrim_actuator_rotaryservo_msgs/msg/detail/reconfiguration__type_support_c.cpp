...
#include "hrim_actuator_rotaryservo_msgs/msg/detail/reconfiguration__rosidl_typesupport_fastrtps_c.h"
...
using _Reconfiguration__ros_msg_type = hrim_actuator_rotaryservo_msgs__msg__Reconfiguration;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Reconfiguration__ros_msg_type * ros_message = static_cast<const _Reconfiguration__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Reconfiguration__ros_msg_type * ros_message = static_cast<_Reconfiguration__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_hrim_actuator_rotaryservo_msgs__msg__Reconfiguration(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Reconfiguration__ros_msg_type * ros_message = static_cast<const _Reconfiguration__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Reconfiguration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hrim_actuator_rotaryservo_msgs__msg__Reconfiguration(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hrim_actuator_rotaryservo_msgs
size_t max_serialized_size_hrim_actuator_rotaryservo_msgs__msg__Reconfiguration(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_hrim_actuator_rotaryservo_msgs__msg__Reconfiguration(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Reconfiguration = {
...
static rosidl_message_type_support_t _Reconfiguration__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Reconfiguration,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_actuator_rotaryservo_msgs, msg, Reconfiguration)() {
  return &_Reconfiguration__type_support;
}
