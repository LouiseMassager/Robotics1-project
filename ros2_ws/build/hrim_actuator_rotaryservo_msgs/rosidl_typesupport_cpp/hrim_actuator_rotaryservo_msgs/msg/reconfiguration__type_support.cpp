...
static const _Reconfiguration_type_support_symbol_names_t _Reconfiguration_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hrim_actuator_rotaryservo_msgs, msg, Reconfiguration)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hrim_actuator_rotaryservo_msgs, msg, Reconfiguration)),
  }
};
...
{
  return &::hrim_actuator_rotaryservo_msgs::msg::rosidl_typesupport_cpp::Reconfiguration_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hrim_actuator_rotaryservo_msgs, msg, Reconfiguration)() {
  return get_message_type_support_handle<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration>();
}
