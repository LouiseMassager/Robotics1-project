...
static const _Temperature_type_support_symbol_names_t _Temperature_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hrim_actuator_rotaryservo_msgs, msg, Temperature)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hrim_actuator_rotaryservo_msgs, msg, Temperature)),
  }
};
...
{
  return &::hrim_actuator_rotaryservo_msgs::msg::rosidl_typesupport_cpp::Temperature_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hrim_actuator_rotaryservo_msgs, msg, Temperature)() {
  return get_message_type_support_handle<hrim_actuator_rotaryservo_msgs::msg::Temperature>();
}
