...
#ifndef HRIM_ACTUATOR_ROTARYSERVO_MSGS__MSG__DETAIL__RECONFIGURATION__STRUCT_HPP_
#define HRIM_ACTUATOR_ROTARYSERVO_MSGS__MSG__DETAIL__RECONFIGURATION__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__hrim_actuator_rotaryservo_msgs__msg__Reconfiguration __attribute__((deprecated))
#else
# define DEPRECATED__hrim_actuator_rotaryservo_msgs__msg__Reconfiguration __declspec(deprecated)
#endif
...
struct Reconfiguration_
{
  ...
  // pointer types
  using RawPtr =
    hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator> *;
  using ConstRawPtr =
    const hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__hrim_actuator_rotaryservo_msgs__msg__Reconfiguration
    std::shared_ptr<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__hrim_actuator_rotaryservo_msgs__msg__Reconfiguration
    std::shared_ptr<hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<ContainerAllocator> const>
...
using Reconfiguration =
  hrim_actuator_rotaryservo_msgs::msg::Reconfiguration_<std::allocator<void>>;
...
#endif  // HRIM_ACTUATOR_ROTARYSERVO_MSGS__MSG__DETAIL__RECONFIGURATION__STRUCT_HPP_
