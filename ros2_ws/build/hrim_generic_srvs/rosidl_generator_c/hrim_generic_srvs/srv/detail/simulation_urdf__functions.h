...
#ifndef HRIM_GENERIC_SRVS__SRV__DETAIL__SIMULATION_URDF__FUNCTIONS_H_
#define HRIM_GENERIC_SRVS__SRV__DETAIL__SIMULATION_URDF__FUNCTIONS_H_
...
/// Initialize srv/SimulationURDF message.
/**
...
/// Finalize srv/SimulationURDF message.
/**
...
/// Create srv/SimulationURDF message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hrim_generic_srvs__srv__SimulationURDF_Request__init().
...
/// Destroy srv/SimulationURDF message.
/**
 * It calls
 * hrim_generic_srvs__srv__SimulationURDF_Request__fini()
...
/// Initialize array of srv/SimulationURDF messages.
/**
...
/// Finalize array of srv/SimulationURDF messages.
/**
 * It calls
 * hrim_generic_srvs__srv__SimulationURDF_Request__fini()
...
/// Create array of srv/SimulationURDF messages.
/**
 * It allocates the memory for the array and calls
 * hrim_generic_srvs__srv__SimulationURDF_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SimulationURDF messages.
/**
 * It calls
 * hrim_generic_srvs__srv__SimulationURDF_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hrim_generic_srvs__srv__SimulationURDF_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hrim_generic_srvs
...
/**
 * It calls
 * hrim_generic_srvs__srv__SimulationURDF_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hrim_generic_srvs
...
/**
 * It allocates the memory for the array and calls
 * hrim_generic_srvs__srv__SimulationURDF_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hrim_generic_srvs
...
/**
 * It calls
 * hrim_generic_srvs__srv__SimulationURDF_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HRIM_GENERIC_SRVS__SRV__DETAIL__SIMULATION_URDF__FUNCTIONS_H_
