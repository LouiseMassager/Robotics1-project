...
static const _ID_Request_type_support_symbol_names_t _ID_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_generic_srvs, srv, ID_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hrim_generic_srvs, srv, ID_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hrim_generic_srvs, srv, ID_Request)() {
  return &::hrim_generic_srvs::srv::rosidl_typesupport_c::ID_Request_message_type_support_handle;
}
...
static const _ID_Response_type_support_symbol_names_t _ID_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_generic_srvs, srv, ID_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hrim_generic_srvs, srv, ID_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_hrim_generic_srvs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hrim_generic_srvs, srv, ID_Response)() {
  return &::hrim_generic_srvs::srv::rosidl_typesupport_c::ID_Response_message_type_support_handle;
}
...
static const _ID_type_support_symbol_names_t _ID_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_generic_srvs, srv, ID)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hrim_generic_srvs, srv, ID)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hrim_generic_srvs, srv, ID)() {
  return &::hrim_generic_srvs::srv::rosidl_typesupport_c::ID_service_type_support_handle;
}
