...
#include "hrim_generic_msgs/msg/detail/power__rosidl_typesupport_fastrtps_c.h"
...
using _Power__ros_msg_type = hrim_generic_msgs__msg__Power;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: current_consumption
  {
    cdr << ros_message->current_consumption;
  }

  // Field name: current_surplus
  {
...
size_t get_serialized_size_hrim_generic_msgs__msg__Power(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Power__ros_msg_type * ros_message = static_cast<const _Power__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Power__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hrim_generic_msgs__msg__Power(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hrim_generic_msgs
size_t max_serialized_size_hrim_generic_msgs__msg__Power(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_hrim_generic_msgs__msg__Power(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hrim_generic_msgs, msg, Power)() {
